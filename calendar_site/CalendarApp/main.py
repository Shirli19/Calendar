...
import detectar_meses as detectar_meses
import detectar_dias as detectar_dias
from obtener_eventos import obtener_eventos
import inicializar as inicializar
...
def main():
    ...
    cv.createTrackbar('calendario', 'Digitalizador', 15, 29, funciones.nothing)  # la numero 8 revienta
    ...
    while 1: # iterar hasta presionar escape o letra Q
        ...
        for nro_mes, (mes_bin, mes_color) in enumerate(zip(meses_recortados_pre_procesados, meses_recortados_pre_procesados_color)):
            ...
            eventos = obtener_eventos(mat_con_dias, pos_cols, pos_filas, mes_color, nro_mes+1)
